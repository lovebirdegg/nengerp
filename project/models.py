...
class BaseModel(models.Model):
    ...
    updateTime = models.DateTimeField(verbose_name="修改时间",default=timezone.now)
    deletedTime = models.DateTimeField("删除时间",null=True, blank=True,default=None)
    createdBy = models.IntegerField(verbose_name="创建人ID",default=0)
    updatedBy = models.IntegerField(verbose_name="修改人ID",default=0)
...
class Custom(BaseModel):
    name = models.CharField('客户名称', max_length=32, blank=True)
...
class Project(BaseModel):
    ...
    contractNetAmount = models.FloatField('合同净额',blank=True,default=0)
